...
const Game = () => {
    ...
    return (
        <div className=" md:flex-row flex-col" style={{ display: 'flex', height: '100vh', width: '100vw' }}>
            {started ? (
                <>
                    ...
                    <div style={{ flex: '0 0 20%', backgroundColor: '#f0f0f0', padding: '20px', overflowY: 'auto' }}>
                        <div>Game Info</div>
                    </div>
                </>
            ) : (
